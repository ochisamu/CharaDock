...
(function initializeCharaDockI18n(root) {
  ...
  const ENGLISH = Object.freeze({
    ...
    "Qwen2.5 0.5Bが端末内で発話文と感情候補を生成します": "Qwen2.5 0.5B generates spoken updates and emotion cues on this device",
    "約800MBのモデルは明示的に準備するまでダウンロードしません。最終回答とGPT-Liveには適用されません。": "The approximately 800 MB model is downloaded only when you prepare it. Final answers and GPT-Live are unchanged.",
