...
(function initializeCharaDockI18n(root) {
  ...
  const ENGLISH = Object.freeze({
    ...
    "外部ネットワーク接続": "External network access",
    "WorkからAPI・パッケージ取得・名前解決を利用できます": "Allow Work to access APIs, download packages, and resolve host names",
    "なし": "None",
    "最小": "Minimal",
    "低": "Low",
    "中": "Medium",
    ...
    "最大": "Maximum",
    "作業": "Work",
    "深くするほど応答に時間がかかる場合があります。外部接続は安全のため初期状態ではOFFです。ONにすると、作業先のコードも外部へ通信できるようになります。": "Deeper reasoning can take longer. External access is off by default for safety. When enabled, code in the workspace can also communicate externally.",
